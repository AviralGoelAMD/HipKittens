...
// co-resides in one lane (C[r][0], C[r][1]); the rotation is register-only. The result is stored
// in permuted column order by apply_rope_store -- valid because the consumer is
